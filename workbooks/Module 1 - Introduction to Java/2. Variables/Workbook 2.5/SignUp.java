...
public class SignUp {
    ...
    public static void main(String[] args) {
        ...
        scan.nextLine(); //Throwaway nextLine to get around the trap
        String userName = scan.nextLine();

        System.out.println("What city do you live in?");
        String placeOfResidence = scan.nextLine();

        System.out.println("What country is that?");
        String countryOfResidence = scan.nextLine();
        ...
        System.out.println("\tCountry: "+countryOfResidence);
